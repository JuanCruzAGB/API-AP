...
@section("main")
    <section id="property" class="property grid gap-4">
        ...
        <main class="grid gap-4">
            <section id="gallery-item" class="gallery">
                ...
                {{-- <a target="_blank" href="{{ asset("storage/property/1/01.jpg") }}"> --}}
                    <img class="gallery-item gallery-image" src="{{ asset("storage/" . $property->files[0]) }}" alt="{{ $property->name }} - Image selected">
